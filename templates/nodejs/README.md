...
[![npm](https://img.shields.io/npm/v/meta-nodejs-business-sdk)](https://www.npmjs.com/package/meta-nodejs-business-sdk)
[![License](https://img.shields.io/badge/license-Facebook%20Platform-blue.svg?style=flat-square)](https://github.com/facebook/meta-nodejs-business-sdk/blob/main/LICENSE)
[![Build Status](https://img.shields.io/github/actions/workflow/status/facebook/meta-nodejs-business-sdk/ci.yml)](https://github.com/facebook/meta-nodejs-business-sdk/actions/workflows/ci.yml)
...
`npm install --save meta-nodejs-business-sdk`

Bower

`bower install --save meta-nodejs-business-sdk`
...
```javaScript
const adsSdk = require('meta-nodejs-business-sdk');
